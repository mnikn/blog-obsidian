我看了很多次 autotile 和 tileset 相关的视频了，看视频时能理解，但是到了自己真正要做 autotile 要用的 tileset 时基本上不知道怎么做，想来想去原因应该是 tileset 的 tile 比较多，做起来不知道 autotile 时怎么对应，所以我把每一个 tile 的制作的对应方式都记录下来。
